...
CREATE TABLE cars_photos (
   id              SERIAL,
   ad_id           INTEGER,
CONSTRAINT cars_photos_pk PRIMARY KEY (id) --REFERENCES cars_ads(id)
);
...
CREATE TABLE cars_ads (
   ...
   inserted_date         TIMESTAMP,
    CONSTRAINT cars_ads_pk PRIMARY KEY (id)
);
...
CONSTRAINT cars_ads_heating_details_pk PRIMARY KEY (id)
);
